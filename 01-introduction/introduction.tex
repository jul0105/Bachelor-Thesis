...
Passwords are a problem. They are hard to remember and to manage for the user. A password manager can help to manages password but the greater underlying problem is not here.
