...
% - study existing PAKE
% - old one and moderne one: SRP, OPAQUE, KHAPE, EKE, OKE (cass̩), variantes d'EKE (PAK, PPK, PAK-X,), SNAPI, PEKEP. (pas besoin d'aller trop dans les d̩tails pour les anc̻tres)
