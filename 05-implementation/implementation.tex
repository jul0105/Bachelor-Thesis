...
\begin{itemize}
 ...
 \item \verb|server_register_finish(e, A, b, salt): file_entry|
    % store (e, b, A, salt) % TODO how to store salt and b (secret) ?
\end{itemize}
...
\begin{itemize}
 ...
 \item \verb|server_auth_start(uid, h1, file): (e, Y, h2)|
    ...
    % return e, Y, y, h2 % TODO how to store y ?
 ...
 \item \verb|server_auth_finish(X, Y, A, y, b, t1, file): (K2, t2)|
    ...
    % verify t1
    % compute t2 and K2
    % return K2, t2 % TODO what to do with K2 (session key) ? Store in db ? Expiration ?
