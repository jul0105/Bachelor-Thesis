...
It got broken and patched multiple time --- current version is SRP v6a (which is not broken). % TODO cite website
...
% To avoid this kind of attacks, KHAPE use 2 mains mechanisms. 1) Non-commiting encryption, 2) Key-hiding AKE. (PAS SUR DU TOUT)
