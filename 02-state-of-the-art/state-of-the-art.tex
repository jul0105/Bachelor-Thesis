...
%      3 & Server doesn't send salt in cleartext & - (no salt) & x & Yes & Yes (OPRF) (without OPRF there is no salt) \\ \hline
     ...
     12 & Standardization status & RFC for EAP-EKE \cite{EAP_EKE_RFC} & TBD & Internet standard draft \cite{OPAQUE_Standard_Draft} & Crypto 2021 Paper \cite{KHAPE_Paper} \\ \hline
...
\begin{center}
   \begin{tabular}{ | c | p{6cm} || p{2cm} | p{1cm} | p{2cm} | p{2cm} | }
     ...
     15 & Number of messages & 4 ? & TBD & 3 & 4 (3 if client initiate) \\ \hline
     16 & Number of exponentiations & 4 ? & TBD & 3 or 4 ? & 2 + 1 hash-to-curve \\ \hline
     20 & Computational cost compared to a KE (see \cite{KHAPE_Paper} presentation) & 1x & TBD & 2x & 1x without OPRF, 2x with OPRF \\ \hline
     21 & Communication size & TBD & TBD & TBD & TBD \\ \hline
     22 & Server-side storage size & TBD & TBD & TBD & TBD \\ \hline
     
     17 & Patented & Yes, expired in 2011 & No & No & No \\ \hline
     18 & Year published & 1992 & 1998 & 2018 & 2021 \\ \hline
     19 & Got broken & Yes (source ?) & Yes and patched \cite{CAA} & TBD & TBD \\ \hline
