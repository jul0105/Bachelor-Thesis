...
On the other hand, KHAPE only fall back to a non-strong aPAKE if OPRF breaks (making it vulnerable to pre-computation attacks). This make KHAPE more resistant to OPRF compromise than OPAQUE. 
