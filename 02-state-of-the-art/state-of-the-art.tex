...
Another feature provided by OPRF
...
COMMENT: In SRP, $\mathbb{Z}_p$ is used as a field, not a group. Therefore, SRP cannot be easily adapted to elliptic curves \cite{CAA}.
...
\begin{center}
   \begin{tabular}{ | c | p{5cm} || p{2cm} | p{2cm} | p{2cm} | p{2cm} | }
     ...
     13 & Easily adaptable to elliptic curves & Yes ? & No* & Yes & Yes ? \\ \hline
