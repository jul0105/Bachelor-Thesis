...
Since the only ressource for KHAPE is the rather theorical paper, lots of design choice will have to be made. However, since OPAQUE and KHAPE share similarities, some implementation choice will be inspired by the OPAQUE standard draft whenever it's possible.
