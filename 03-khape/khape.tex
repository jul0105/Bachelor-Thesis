...
The simplest construction is the one detailed in \cite{https://arxiv.org/pdf/1011.1264.pdf} which is an update from \cite{https://eprint.iacr.org/2008/246.pdf} that got broken.
...
Elligator-squared and Elligator2 are implementation for such curve point encoding.
...
There is also an ongoing standard draft protocol for OPRF \cite{https://datatracker.ietf.org/doc/draft-irtf-cfrg-voprf/} that present multiple ciphersuites for OPRF and different variants.
